...
test('upgrade tao exported pci resolves page content asset references from content-* properties', async () => {
  const input = xml`<?xml version="1.0" encoding="UTF-8"?>
   <qti-custom-interaction response-identifier="RESPONSE">
    <qti-portable-custom-interaction custom-interaction-type-identifier="textReaderInteraction" data-base-url="https://example.org/assets">
      <properties>
        <properties key="pages">
          <properties key="0">
            <properties key="content">
              <property key="0">&lt;div&gt;&lt;img src="images/pic.png"/&gt;&lt;/div&gt;</property>
            </properties>
          </properties>
        </properties>
        <property key="content-pic.png">data:image/png;base64,AAAA</property>
      </properties>
      <markup>
        <div class="pciInteraction"/>
      </markup>
  ...
  const expectedOutput = xml`<?xml version="1.0" encoding="UTF-8"?>
<qti-portable-custom-interaction custom-interaction-type-identifier="textReaderInteraction" data-pages__0__content__0="&lt;div&gt;&lt;img src=&quot;data:image/png;base64,AAAA&quot;/&gt;&lt;/div&gt;" data-content-pic.png="data:image/png;base64,AAAA" module="textReaderInteraction" response-identifier="RESPONSE">
  <qti-interaction-markup>
    <div class="pciInteraction"/>
  </qti-interaction-markup>
</qti-portable-custom-interaction>`;
...
test('upgrade pci no longer injects tao-specific legacy attributes', async () => {
  const input = xml`<?xml version="1.0" encoding="UTF-8"?>
<qti-assessment-item tool-name="TAO">
      ...
      <qti-portable-custom-interaction custom-interaction-type-identifier="textReaderInteraction">
        <properties>
          ...
          <properties key="pages">
            <properties key="0">
              <properties key="content">
                <property key="0">&lt;div&gt;x&lt;/div&gt;</property>
              </properties>
            </properties>
          </properties>
        </properties>
        <markup><div class="pciInteraction"/></markup>
      </qti-portable-custom-interaction>
    </qti-custom-interaction>
  </qti-item-body>
</qti-assessment-item>`;
  ...
  const pci = $('qti-portable-custom-interaction');

  expect(pci.attr('data-legacy-pci-proxy')).toBeUndefined();
  expect(pci.attr('data-require-paths')).toBeUndefined();
  expect(pci.attr('data-legacy-pci-config')).toBeUndefined();
});
